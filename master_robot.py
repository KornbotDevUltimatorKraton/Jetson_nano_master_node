...
def mainbody_status_devices(): 
      for ty in count(0):
            ...
            dict_host_info = {'PID_process':os.getpid(),host_namea.hostname:ipa.ip,'Serial_devices':host_info,'Camera_list':cam_list_mem,'Audio_list':audio_mem,'RSSI':rssi_raw,'RSSI_distance':rssi_distance,"Speech_sr":mem_speech}
